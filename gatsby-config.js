const config = {
  ...
  shortTitle: 'FM Sign-up form',
  // Project description. Used in SEO meta tag and by PWA
  description: 'My solution for Frontend Mentor "Intro component with sign-up form" challenge',
  ...
  baseUrl: 'https://p1t1ch-fm-sign-up-form.netlify.app',
